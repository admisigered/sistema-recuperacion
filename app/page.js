...
// --- 2. UTILIDADES DE FECHA CONSOLIDADAS (CORREGIDO) ---
const dateUtils = {
  toStandard: (val) => {
  ...
  today: () => new Date().toISOString().split('T')[0], // CORREGIDO: Ya no se llama a sí mismo
  diffHabiles: (fechaRef) => {
    ...
    let hoy = new Date(); // CORREGIDO: Usamos Date directamente para setHours
